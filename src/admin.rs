    ...
    match msg.reply_to_message() {
        Some(replied) => {
            ...
            if is_admin_or_owner {
                ...
                bot.send_message(chat_id, format!("✅ @{} desbaneado", username_user)).await?;
        ...
        None => {
            ...
            if is_admin_or_owner {
                ...
                bot.delete_message(msg.chat.id, msg.id).await?;
                bot.send_message(msg.chat.id, format!("✅ Desbaneado \\[`{}`\\]", user_id)).await?;
                bot.send_video(chat_id, InputFile::file("./assets/unban/1.mp4")).await?;
    ...
    match msg.reply_to_message() {
        ...
        None => {
            ...
            if is_admin_or_owner {
                ...
                bot.delete_message(msg.chat.id, msg.id).await?;
                bot.send_message(msg.chat.id, format!("Silenciado \\[`{}`\\]", user_id)).await?;
    ...
    match msg.reply_to_message() {
        ...
        None => {
            ...
            if is_admin_or_owner {
                ...
                bot.delete_message(msg.chat.id, msg.id).await?;
                bot.send_message(msg.chat.id, format!("\\[`{}`\\] ya no esta silenciado", user_id)).await?;
                bot.send_video(msg.chat.id, InputFile::file("./assets/unmute/unmute.mp4")).await?;
